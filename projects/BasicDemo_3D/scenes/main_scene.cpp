...
#elif GAME_MODE_CONFIGURATION == GAME_3D_CONFIGURATION
    const glm::vec3 collisionAreaCenter = kCollisionAreaPosition + (kCollisionAreaSize * 0.5f);
    RS_MN.RenderParallelepipedLines(collisionAreaCenter, kCollisionAreaSize, glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(0.0f, 0.65f, 1.0f), 0.85f, 2.25f, false, CosmicEngine::ViewType::Projection);
